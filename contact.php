<?php
	...
	if (isset($_POST['email'])) {
		...
		$email_to = "4890965@gmail.com";
		$email_subject = "My offer for jtxqj.com";
...
<html lang="en">
		<head>
				<meta charset="utf-8">
				<title>Sales Inquery || jtxqj.com</title>
									...
									<div class="vMiddle">
										...
										<div class="row d-md-flex text-center justify-content-center text-primary action-icons">
											<div class="col-sm-4">
												...
												<p class="lead"><a href="tel:+12184890965">+12184890965</a></p>
											</div>
											<div class="col-sm-4">
												<p><em class="ion-ios-chatbubble-outline icon-md"></em></p>
												<p class="lead"><a href="mailto:4890965@gmail.com">4890965@gmail.com</a></p>
											</div>
									</div>
								</div>
							</div>
									...
									<section class="bg-alt">
											<div class="row height-100">
													<div class="col-sm-8 offset-sm-2 mt-2">
														...
														<br/>
														<a target="_blank" rel="nofollow" href="https://www.jtxqj.com">www.jtxqj.com</a>
													</div>
											</div>
									</section>
							</div>
